...
public class PhotoModelHelper {
	...
	private static final String table3 = "CREATE TABLE " + photosTable + " (" + photosTableID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + photosTablePhoto + " BLOB, " + photosTableAnnotation + " TEXT, " + photosTableGroup + " TEXT, " + photosTableTags + " TEXT, " + photosTableDoctorTags + " TEXT, " + photosTableDate + " TEXT);";
